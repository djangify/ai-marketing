...
STRIPE_PRICE_ID_MONTHLY = env(
    "STRIPE_PRICE_ID_MONTHLY", default="price_1RHL24BSytWSX0dbjJFz6BQO"
)
STRIPE_PRICE_ID_QUARTERLY = env(
    "STRIPE_PRICE_ID_QUARTERLY", default="price_1RHL4KBSytWSX0db7cIwLiDc"
)
STRIPE_PRICE_ID_YEARLY = env(
    "STRIPE_PRICE_ID_YEARLY", default="price_1RHL63BSytWSX0dbfT6OzPq4"
)
